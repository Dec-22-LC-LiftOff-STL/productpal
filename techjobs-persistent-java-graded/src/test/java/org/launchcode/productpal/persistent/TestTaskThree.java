...
import org.launchcode.productpal.persistent.models.AbstractEntity;
...
public class TestTaskThree extends AbstractTest {
    ...
    public void testJobFieldIsProperlyDefined() throws ClassNotFoundException, IllegalAccessException {
        ...
        ArrayList<Product> initializedList = (ArrayList<Product>) jobsField.get(category);

        for (Product item : initializedList) {
    ...
    public void testEmployerField() throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException {
        ...
        assertEquals(Category.class, employerField.getType());
        ...
        assertEquals(Category.class, getEmployerMethod.getReturnType());

        try {
            Method setEmployerMethod = jobClass.getMethod("setEmployer", Category.class);
     ...
     * */
    @Test
    public void testHomeControllerFetchesEmployers(@Mocked CategoryRepository categoryRepository, @Mocked SkillRepository skillRepository) throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        Class homeControllerClass = getClassByName("controllers.HomeController");
